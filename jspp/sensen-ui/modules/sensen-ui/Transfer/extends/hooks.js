...
export function useTargetIndex (intialIndex) {
  const targetIndex = ref(intialIndex);
...
export function useCheckedData () {
  ...
  function removeCheckededData (leftOrRight, id) {
    switch (leftOrRight) {
      case 'left':
  ...
  return [ checkedData, addCheckedData, removeCheckededData ];
}
